          ...
          <div className="flex flex-col md:flex-row" key={index}>
            <div className="md:w-[350px] shadow-lg relative">
              <div>
                ...
                <div className="absolute top-1 right-1 bg-red-500 text-white px-4 py-2 rounded sm:text-sm md:text-base lg:text-lg">
                  <span className="font-bold">${cart.price}</span>
                  <span className="text-xs md:text-sm"> / per person</span>
                </div>

                <div className="w-[95%] bg-[#50d71e] h-[50px] relative bottom-[30px]  left-[2%] right-[2%]">
                  <div
